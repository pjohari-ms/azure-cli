...
def load_arguments(self, _):
    ...
    for scope in ['cosmosdb create', 'cosmosdb update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('backup_retention_lock_expiration_timestamp', options_list=['--backup-retention-lock-expiration-timestamp', '--retention-lock-until'], action=UtcDatetimeAction, help="The retention lock expiration timestamp for continuous mode backups.", arg_group='Backup Policy')
